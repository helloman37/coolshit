...
SUPPORTED_DEBIAN_RELEASES='@(buster|bullseye|bookworm|kali)'
SUPPORTED_UBUNTU_RELEASES='@(trusty|xenial|bionic|cosmic|disco|eoan|focal|groovy|hirsute|impish|jammy|kinetic)'
